...
app.get("/random" ,  (req , res)=>{
  ...
  // let result = JSON.stringify(jokes[random]);
...
app.get("/filter" , (req , res)=>{
  ...
  let jokeList = jokes.filter((joke) => joke.jokeType === query)
  res.json(jokeList);
...
app.delete("/all" , (req ,res ) =>{
  ...
  if ( userProvidedKey === masterKey) {
    ...
    res.sendStatus(404).json({ error : `User provided key does not match to the master key. No jokes were deleted ..`})
  };
});
